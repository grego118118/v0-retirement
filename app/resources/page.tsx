        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="bg-white dark:bg-mrs-navy-800 border-indigo-100 dark:border-indigo-900/50">
                <CardHeader>
              ...
              <Card className="bg-white dark:bg-mrs-navy-800 border-blue-100 dark:border-blue-900/50">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
              ...
              <Card className="bg-white dark:bg-mrs-navy-800 border-green-100 dark:border-green-900/50">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
