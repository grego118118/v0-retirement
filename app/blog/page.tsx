          ...
          <Card className="overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="relative h-48 md:h-full bg-muted">
                <ResponsiveBlogImage
                  src={blogPosts[0]?.image || "/images/blog/default-blog-image.svg"}
                  alt={blogPosts[0]?.title || "Featured Blog Post"}
                  aspectRatio="16/9"
                  priority={true}
                />
              </div>
              <div className="p-6">
                ...
                <div className="flex items-center text-sm text-muted-foreground mb-4">
                  <CalendarIcon className="mr-1 h-3 w-3" /> {blogPosts[0]?.date}
                  <span className="mx-2">•</span>
                  <Clock className="mr-1 h-3 w-3" /> {blogPosts[0]?.readTime}
                </div>
                <Button asChild>
                  <Link
