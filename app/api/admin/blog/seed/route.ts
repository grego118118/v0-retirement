    ...
    const posts = [
      {
        ...
        metaDescription: 'How WEP and GPO could change under the Social Security Fairness Act and what it means for Massachusetts state employees.',
      ...
      },
      {
        ...
        metaDescription: 'Compare Options A, B, and C for Massachusetts state pensions, including reductions and survivor benefits.',
      ...
      },
      {
        ...
        metaDescription: 'A practical planning timeline for Massachusetts state employees approaching retirement.',
