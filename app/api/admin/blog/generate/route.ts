    ...
    try {
      savedPost = await prisma.blogPost.create({
        data: {
          ...
          excerpt: generatedPost.metaDescription || generatedPost.content.substring(0, 200),
          ...
          contentQualityScore: qualityMetrics.overallQuality,
          ...
          seoDescription: generatedPost.metaDescription || '',
