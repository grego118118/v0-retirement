          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{((pensionData as any).benefitPercentage || 0).toFixed(2)}%</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {(pensionData as any).retirementOption === 'C' && (
                    <div className="flex justify-between">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{(socialSecurityData as any).fullRetirementAge}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Claiming Age:</span>
                    <span className="font-medium">{(socialSecurityData as any).selectedClaimingAge}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Full Benefit Amount:</span>
                    <span className="font-medium">${(socialSecurityData as any).fullRetirementBenefit?.toLocaleString()}</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between">
                  ...
                  {(socialSecurityData as any).selectedClaimingAge !== (socialSecurityData as any).fullRetirementAge && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Adjustment:</span>
                      <span className="font-medium">
                        {(socialSecurityData as any).selectedClaimingAge < (socialSecurityData as any).fullRetirementAge ? 'Early' : 'Delayed'} Claiming
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  {(incomeData as any).otherRetirementIncome > 0 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Other Income:</span>
                      <span className="font-medium">${(incomeData as any).otherRetirementIncome.toLocaleString()}</span>
                    </div>
                  )}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-blue-700">
                ...
                {(socialSecurityData as any).selectedClaimingAge < (socialSecurityData as any).fullRetirementAge && (
                  <p>💡 Consider delaying Social Security to your full retirement age ({(socialSecurityData as any).fullRetirementAge}) to avoid early claiming penalties.</p>
                )}
